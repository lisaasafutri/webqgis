...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [112.035300, -1.763281, 118.881243, 3.084451], maxZoom: 28, minZoom: 2, projection: new ol.proj.Projection({
            code: 'EPSG:4326',
            //extent: [-20037508.342789, -85235164599211200.000000, 13950872550953000.000000, 30436742353455600.000000],
            units: 'degrees'})
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([112.035300, -1.763281, 118.881243, 3.084451], map.getSize());
...
var searchLayer = new SearchLayer({
    layer: lyr_indonesia_1,
    colName: 'NAMA ITEM DATA',
    zoom: 10,
    collapsed: true,
    map: map
});
